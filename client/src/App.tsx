  ...
  return (
    <div className='overflow max-h-screen max-w-screen '>
      <div className='absolute h-full w-full bg-blue-100/50 backdrop-blur-5xl flex justify-center items-center'>
        <div className=' rounded-xl p-10 bg-white/90 shadow-lg flex flex-col '>
          <span className='font-mono font-semibold text-lg'>{isReturnedUser ? "Welcome back, Captain!" : "Looks like you're new here!"}</span> 
          <div>
